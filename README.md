...
3. To pretrain MSCDT_S1, run
```
sh MSCDTS1.sh
```

4. To train MSCDT_S2, run
```
#set the 'pretrain_network_g' and 'pretrain_network_S1' in ./options/train_MSCDTS2.yml to be the path of MSCDT_S1's pre-trained model
...
- Testing
```
# modify the dataset path in ./options/test_MSCDTS2.yml
