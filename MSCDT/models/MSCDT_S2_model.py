...
from basicsr.models.sr_model_LBP import SRModel_LBP
from basicsr.utils import DiffJPEG, USMSharp
from basicsr.utils.img_process_util import filter2D
from basicsr.utils.registry import MODEL_REGISTRY
from torch.nn import functional as F
from collections import OrderedDict
from MSCDT.models import lr_scheduler as lr_scheduler
...
from MSCDT.data.data_util import (paired_paths_from_folder,
                                    paired_DP_paths_from_folder,
                                    paired_paths_from_lmdb,
                                    paired_paths_from_meta_info_file)
from MSCDT.data.transforms import augment, paired_random_crop, paired_random_crop_DP, random_augmentation
from MSCDT.utils import FileClient, imfrombytes, img2tensor, padding, padding_DP, imfrombytesDP
...
model_path = '/home/b109/XFH/MSCDT-master/MSCDT-LBP/MSCDT/models/MSCDT_S2_model.py'
...
class MSCDTS2Model(SRModel_LBP):
    """
    ...
    def __init__(self, opt):
        super(MSCDTS2Model, self).__init__(opt)
        if self.is_train:
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(MSCDTS2Model, self).nondist_validation_3(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
