...
class MSCDTS1Model(SRModel_LBP):
    """
    ...
    def __init__(self, opt):
        super(MSCDTS1Model, self).__init__(opt)
        if self.is_train:
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(MSCDTS1Model, self).nondist_validation_3(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
